...
public class AdminManager {
    ...
    private static void AdminMemberMenu() throws InterruptedException {
        ...
        while (!(Secim == "A")) {
            ...
            System.out.print("\u001B[1;33m" + "Seçiminiz:" + "\u001B[0m");
            Secim = Consol.nextLine().toUpperCase();
            switch (Secim) {
                case "1":
                    MemberProcessing.UyeListesiYazdir();
                    break;
                case "2":
                    MemberProcessing.SoyisimdenUyeBul();
                    break;
                case "3":
                    MemberProcessing.SehreGoreUyeBul();
                    break;
                case "4":
                    MemberProcessing.UyeEkleme();
                    break;
                case "5":
                    MemberProcessing.TcNoIleUyeSil();
                    break;
                case "6":
                    MemberProcessing.KayitTalepYazdir();
                    break;
                case "7":
                    MemberProcessing.YonetimTalepKontrol();
                    break;
                case "A":
                    System.out.println("\u001B[1;32m" + "Yükleniyor..." + "\u001B[0m");
                    for (int i = 0; i < 20; i++) {
        ...
        while (!(Secim == "A")) {
            ...
            switch (Secim) {
                ...
                case "3":
                    ...
                    break;
                case "4":
                    BookProcessing.KitapEkle();
                    break;
                case "5":
                    BookProcessing.IsimleKitapSil();
                    break;
                case "6":
